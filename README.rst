FacetView_ is a pure javascript frontend for ElasticSearch search indices. 

It's been developed as a jQuery plugin and lets you easily embed a faceted
browse front end into any web page, or it functions well standalone. 

This Development is now taking place in this repo: http://github.com/okfn/facetview
